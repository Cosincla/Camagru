...
if (!empty($_POST['new'])){
    ...
    $link    = 'http://localhost/Camagru/pswd/pswd_v.php';
    ...
    echo '<script type=text/javascript>alert("A verification email has been sent"); window.location="http://localhost/Camagru/main_page/mp.php";</script>';
}
else
    echo '<script type=text/javascript>alert("Invalid input"); window.location="http://localhost/Camagru/pswd/pswd.php";</script>';
?>