    ...
    <div class="profile" style="position: absolute; border-radius: 250px; width: 5vw; height: 5vw; text-align: center; background-size: cover; background-repeat: no-repeat; background-position: center center;
        ...
        <form name="User Settings">
            <select class="select" style="width: 200px" onchange="location = this.value">
                ...
                <option value="http://localhost/Camagru/mygall/mgall.php">My Gallery</option>
                <option value="http://localhost/Camagru/pswd/pswd.php">Edit Password</option>
                <option value="http://localhost/Camagru/pphoto/pphoto.php">Edit Profile Photo</option>
                <option value="http://localhost/Camagru/user_editing/user_editing.php">Edit Username</option>
                <option value="http://localhost/Camagru/email_edit/email_edit.php">Edit Email</option>
                <option value="http://localhost/Camagru/email_c/email_c.php">Email Settings</option>
                <option value="http://localhost/Camagru/main_page/logout.php">Logout</option>
            </select>
        </form>
    </div>
</div>
<div style="display: flex">
    <div class="left">
        ...
        <div class="view">
            ...
            <video id="video" width="100%" height="100%" autoplay="true">
                Video not supported by your web browser
            </video>
        </div>
...
<div class="back">
    <a href="http://localhost/Camagru/gallery/gall.php"><p style="text-align: center">Back</p></A>
</div>
