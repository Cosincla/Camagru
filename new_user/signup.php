...
if (!$_POST["first"] || !$_POST["surname"] || !$_POST["username"] || !$_POST["email"] || !$_POST["pwd"] || !$_POST["pwdc"] || ($_POST["pwd"] != $_POST["pwdc"]))
    echo '<script type=text/javascript>alert("Invalid input"); window.location="http://localhost/Camagru/new_user/new.php";</script>';
else
{
    try
    {
        ...
        echo '<script type=text/javascript>alert("A verification email has been sent"); window.location="http://localhost/Camagru/email_v/email_v.php";</script>';
    }
    catch(PDOexception $e)
    {
        echo '<script type=text/javascript>alert("Email/Username is currently in use"); window.location="http://localhost/Camagru/";</script>';
    }
}
?>